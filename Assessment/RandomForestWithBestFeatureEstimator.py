...
#############################################################################
##########  ML Random Forest with Optimal Parameters found :  ###############
##########  n estimators = 200, depth = 100                   ###############
#############################################################################
...
print(rfc_cv_score)
print("=== Mean Of Cross Valiation Score ===")
...
y_pred_class = np.trunc(rfc.predict(x_test))
y_pred_class = y_pred_class.astype(int)
import numpy
numpy.savetxt('results2.csv', y_pred_class, delimiter=',', header="y predicted Random Forest", comments="",fmt="%d")
print('END  Random Forest Algorithm')
########################################################################
